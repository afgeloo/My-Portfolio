...
function Resume() {
    ...
    useEffect(() => {
        ...
        const handleMouseMove = (e: MouseEvent) => {
            ...
            circle.style.transition = 'transform 0.9s ease-out'; // smooth constant transition for circle
    ...
    return (
        <div ref={circleRef} className="circle3">
            <p ref={textRef} className="recentsdesc3">
                Resume
            </p>
        </div>
    );
